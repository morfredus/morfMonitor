...
[![Version](https://img.shields.io/badge/version-0.14.10-blue)](CHANGELOG.md)
...
| Services morfSystem | Unités systemd (dont morfUpdate, sans bouton d'auto-mise à jour), bibliothèques et outils (Beacon, Deploy, Packages, Tools), sondes, versions, bouton **Mettre à jour** (délègue à morfUpdate sur 127.0.0.1 ; le projet envoyé est le dépôt GitHub, pas le libellé). Voir la notice TESTER-MISE-A-JOUR-LOCALE du dépôt morfSystem. |
